...
simulation_study_bootstrap <- function(parameters = list(list(alpha = 0.3, beta = c(0.2,0.4), eta = c(0.3,0.2,0.3)),
                                               ...
                                               list(alpha = 0.5, beta = c(0.2,0.8), eta = c(0.3,0.4,0.5))), sample_length = 500, boot_reps = 100){
  n <- length(parameters)
  ...
  for (i in 1:n) {
    ...
    plots[[i]] <- list(arx_plotting(estimates))
