...
The goal of SimpleMediation is to implement simple linear mediation with
bootstrapping to estimate the error. It provides functions the run
simple mediation with bootstrapping.
...
The returned values are the estimate of the total, direct, and indirect
effects along with their bias and standard error.
